...
define('MODULE_IMPORT_BANK_DESCRIPTION','With this module you can import .csv bank statements. The list is then checked for any outstanding bill or previous bookings with the same description.');
