...
define('PB_PF_TERMS_TO_LANGUAGE','Voorwaarden naar Taal');
...
define('NEXT_CUST_ID_NUM_DESC','Volgende Klant ID');
...
define('HR_ACCOUNT_ID','Departement ID');
define('HR_INFO_SUBACCOUNT','Is dit departement een sub departement?');
define('HR_INFO_PRIMARY_ACCT_ID','Ja, Selecteer het primaire departement:');
define('HR_INFO_ACCOUNT_TYPE','Departement type');
define('HR_INFO_ACCOUNT_INACTIVE','Departement inactief');
define('HR_INFO_INSERT_INTRO','Voer het nieuwe departement in met de bijbehorende data');
define('HR_INFO_NEW_ACCOUNT','Nieuwe afdeling');
define('HR_INFO_EDIT_ACCOUNT','Bewerk Departement');
define('HR_INFO_DELETE_INTRO','Weet u zeker dat u dit departement wil verwijderen?');
define('HR_DEPARTMENT_REF_ERROR','De primaire afdeling kan niet het zelfde zijn als het sub afdeling!');
define('HR_LOG_DEPARTMENTS','Departmenten - ');
define('SETUP_TITLE_DEPT_TYPES','Departement Types');
define('SETUP_INFO_DEPT_TYPES_NAME','Departement Type Naam');
define('SETUP_DEPT_TYPES_INSERT_INTRO','Voer een nieuw departement type in');
define('SETUP_DEPT_TYPES_DELETE_INTRO','Weet u zeker dat u dit departement type wilt verwijderen?');
define('SETUP_DEPT_TYPES_DELETE_ERROR','Kan dit departement type niet verwijderen, het wordt namelijk gebruikt door een departement.');
define('SETUP_INFO_HEADING_NEW_DEPT_TYPES','Nieuw Departement Type');
define('SETUP_INFO_HEADING_EDIT_DEPT_TYPES','Bewerk Departement Type');
define('SETUP_DEPT_TYPES_LOG','Department Types - ');
...
define('SETUP_INFO_COST_TYPE','Kosten Type (als er geen gebruik wordt gemaakt van kosten splitsen)');
